...
export const Sidebar: React.FC<SidebarProps> = ({ activeTab, onSelectTab }) => {
  ...
  return (
    <aside
      ...
      } bg-[#FFFFFF] border-r border-zinc-300 flex flex-col justify-between h-screen sticky top-0 shrink-0 select-none z-30 font-sans rounded-none transition-all duration-200 ease-in-out`}
    >
      {/* Top Header & Brand */}
