...
export const LESSONS_A1_1: Lesson[] = [
  // 01. Спряжение слабых глаголов (6 вопросов)
  {
    id: 'lesson-1',
    number: 1,
    ...
    totalLearners: 1420,
    passThreshold: 70,
    tags: ['A1.1', 'Грамматика', 'Глаголы', 'Präsens'],
    isComingSoon: false,
    questions: [
      {
        id: 'l1-q1',
      ...
      },
      {
        ...
        options: ['er arbeitet', 'er arbeitt', 'er arbeite', 'er arbeiten'],
      ...
      },
      {
        ...
        options: ['du heißt', 'du heißst', 'du heiße', 'du heißen'],
      ...
      },
      {
        ...
        options: ['kommen', 'komme', 'kommst', 'kommt'],
  ...
  // 02. Спряжение сильных глаголов (7 вопросов)
  {
    id: 'lesson-2',
    number: 2,
    ...
    totalLearners: 1350,
    passThreshold: 70,
    tags: ['A1.1', 'Грамматика', 'Сильные глаголы', 'Vokalwechsel'],
    isComingSoon: false,
    questions: [
      {
        id: 'l2-q1',
        ...
        options: ['Sprichst', 'Sprechst', 'Sprecht', 'Sprich'],
      ...
      },
      {
        ...
        options: ['er liest', 'er leset', 'er lest', 'er lieset'],
      ...
      },
      {
        ...
        options: ['schläft', 'schlaft', 'schläfst', 'schlafen'],
      ...
      },
      {
        ...
        options: ['hilft', 'helft', 'hilfst', 'helfen'],
        correctAnswer: 'hilft',
      ...
      },
      {
        ...
        options: ['du siehst', 'du sehst', 'du sieht', 'du sehest'],
  ...
  // 03. Употребление артиклей (7 вопросов)
  {
    id: 'lesson-3',
    number: 3,
    ...
    totalLearners: 1290,
    passThreshold: 70,
    tags: ['A1.1', 'Грамматика', 'Артикли', 'der die das'],
    isComingSoon: false,
    questions: [
      {
        id: 'l3-q1',
        type: 'single-choice',
        promptDe: 'Welcher bestimmte Artikel gehört zu „Tisch“ (стол)?',
      ...
      },
      {
        id: 'l3-q2',
        type: 'single-choice',
        promptDe: 'Welcher Artikel gehört zu „Buch“ (книга)?',
  ...
  // 04. Неправильные глаголы / Порядок слов в простом предложении (8 вопросов)
  {
    id: 'lesson-4',
    number: 4,
    ...
    totalLearners: 1210,
    passThreshold: 70,
    tags: ['A1.1', 'Грамматика', 'Порядок слов', 'sein haben'],
    isComingSoon: false,
    questions: [
      {
        id: 'l4-q1',
      ...
      },
      {
        id: 'l4-q4',
        type: 'single-choice',
        promptDe: 'Welcher Satz hat die richtige Wortstellung (Inversion / обратный порядок)?',
      ...
      },
      {
        ...
        options: ['wird', 'werdet', 'werde', 'wirst'],
        correctAnswer: 'wird',
      ...
      },
      {
        ...
        options: ['weiß', 'weiße', 'wisst', 'wisse'],
        correctAnswer: 'weiß',
      ...
      },
      {
        ...
        options: ['du hast', 'du habst', 'du hat', 'du habe'],
  ...
  // 05. Вопросительные предложения (8 вопросов)
  {
    id: 'lesson-5',
    number: 5,
    ...
    totalLearners: 1180,
    passThreshold: 70,
    tags: ['A1.1', 'Грамматика', 'W-Fragen', 'Вопросы'],
    isComingSoon: false,
    questions: [
      {
        id: 'l5-q1',
  ...
  // 06. Отрицательное предложение (8 вопросов)
  {
    id: 'lesson-6',
    number: 6,
    ...
    totalLearners: 1150,
    passThreshold: 70,
    tags: ['A1.1', 'Грамматика', 'Отрицание', 'nicht kein'],
    isComingSoon: false,
    questions: [
      {
        id: 'l6-q1',
      ...
      },
      {
        ...
        options: ['keinen', 'nicht', 'keine', 'kein'],
  ...
  // 07. Притяжательные местоимения (9 вопросов)
  {
    id: 'lesson-7',
    number: 7,
    ...
    totalLearners: 1100,
    passThreshold: 70,
    tags: ['A1.1', 'Грамматика', 'Местоимения', 'mein dein'],
    isComingSoon: false,
    questions: [
      {
        id: 'l7-q1',
      ...
      },
      {
        ...
        options: ['seinen', 'sein', 'seine', 'seinem'],
      ...
      },
      {
        id: 'l7-q4',
        type: 'fill-gap',
        promptDe: 'Ergänzen Sie (sie = она): „Anna liebt ______ Katze.“ (die Katze)',
        promptRu: 'Вставьте местоимение от «sie» (её): «Анна любит свою/её кошку.»',
        options: ['ihre', 'ihr', 'ihren', 'seine'],
        correctAnswer: 'ihre',
      ...
      },
      {
        ...
        options: ['unser', 'unsere', 'unseren', 'uns'],
        correctAnswer: 'unser',
      ...
      },
      {
        id: 'l7-q6',
        type: 'single-choice',
        promptDe: 'Wie lautet die feminine Form von „euer“ (ihr = вы)?',
        promptRu: 'Как пишется форма местоимения «ваш» для женского рода (euer + e)?',
        options: ['eure', 'euere', 'euren', 'eures'],
        correctAnswer: 'eure',
      ...
      },
      {
        id: 'l7-q7',
        type: 'fill-gap',
        promptDe: 'Ergänzen Sie die Höflichkeitsform (Sie = Вы): „Wie ist ______ Name?“',
        promptRu: 'Вставьте вежливую форму «Ваш»: «Как Ваша фамилия / имя?»',
        options: ['Ihr', 'Ihre', 'Ihren', 'dein'],
        correctAnswer: 'Ihr',
      ...
      },
      {
        id: 'l7-q8',
        type: 'fill-gap',
        promptDe: 'Ergänzen Sie (sie = они): „Die Kinder machen ______ Hausaufgaben.“ (Plural)',
  ...
  // 08. Повелительное наклонение (Imperativ) (9 вопросов)
  {
    id: 'lesson-8',
    number: 8,
    ...
    totalLearners: 1060,
    passThreshold: 70,
    tags: ['A1.1', 'Грамматика', 'Imperativ', 'Команды'],
    isComingSoon: false,
    questions: [
      {
        id: 'l8-q1',
        ...
        options: ['Komm!', 'Kommst!', 'Kommen!', 'Kommt!'],
        correctAnswer: 'Komm!',
      ...
      },
      {
        ...
        options: ['Macht!', 'Machen!', 'Mach!', 'Macht ihr!'],
        correctAnswer: 'Macht!',
      ...
      },
      {
        id: 'l8-q3',
        type: 'single-choice',
        promptDe: 'Wie lautet die höfliche Form (Sie) von „wiederholen“ (повторять)?',
      ...
      },
      {
        ...
        options: ['Fahr!', 'Fähr!', 'Fahre du!', 'Fahrt!'],
        correctAnswer: 'Fahr!',
      ...
      },
      {
        ...
        options: ['Warten', 'Wartet', 'Warte', 'Wartete'],
      ...
      },
      {
        id: 'l8-q8',
        type: 'single-choice',
        promptDe: 'Wie bittet man einen Freund: „Помоги мне, пожалуйста!“ (helfen)',
      ...
      },
      {
        ...
        options: ['Seid!', 'Seien!', 'Seid ihr!', 'Seit!'],
        correctAnswer: 'Seid!',
  ...
  // 09. Количественные и порядковые числительные (10 вопросов)
  {
    id: 'lesson-9',
    number: 9,
    ...
    totalLearners: 1040,
    passThreshold: 70,
    tags: ['A1.1', 'Грамматика', 'Числительные', 'Zahlen'],
    isComingSoon: false,
    questions: [
      {
        id: 'l9-q1',
        ...
        options: ['vierundfünfzig', 'fünfzigundvier', 'vierzigundfünf', 'fünfundvierzig'],
      ...
      },
      {
        id: 'l9-q2',
        type: 'fill-gap',
        promptDe: 'Wie schreibt man „первый“ (1.) auf Deutsch? „Heute ist der ______ Mai.“',
        promptRu: 'Вставьте порядковое числительное «первое (мая)»: «Heute ist der ... Mai.»',
        options: ['erste', 'einste', 'eins', 'ersten'],
        correctAnswer: 'erste',
      ...
      },
      {
        ...
        options: ['fünfundzwanzigsten', 'fünfundzwanzigste', 'fünfundzwanzig', 'fünfzigsten'],
      ...
      },
      {
        ...
        options: ['7:30 Uhr', '8:30 Uhr', '8:00 Uhr', '7:00 Uhr'],
      ...
      },
      {
        id: 'l9-q6',
        type: 'single-choice',
        promptDe: 'Wie lautet das Ordnungszahlwort für „третий“ (3.)?',
        promptRu: 'Как звучит порядковое числительное от числа 3 (третий)?',
        options: ['dritte', 'dreite', 'dreiste', 'dritter'],
      ...
      },
      {
        ...
        options: ['tausend', 'hundert', 'zehnhundert', 'million'],
      ...
      },
      {
        ...
        options: ['siebenundsiebzig', 'siebzigundsieben', 'siebenundsiebenzig', 'siebzehn'],
      ...
      },
      {
        ...
        options: ['vierzehn Uhr fünfzehn', 'fünfzehn Uhr vierzehn', 'viertel zwei', 'halb drei'],
      ...
      },
      {
        ...
        options: ['einunddreißigste', 'einunddreißigsten', 'einunddreißig', 'dreißigste'],
  ...
  // 10. Падежи в немецком предложении (10 вопросов)
  {
    id: 'lesson-10',
    number: 10,
    ...
    totalLearners: 980,
    passThreshold: 70,
    tags: ['A1.1', 'Грамматика', 'Падежи', 'Kasus Dativ Akkusativ'],
    isComingSoon: false,
    questions: [
      {
        id: 'l10-q1',
        ...
        options: ['Wem? (Кому?)', 'Wen? (Кого?)', 'Wer? (Кто?)', 'Was? (Что?)'],
      ...
      },
      {
        ...
        options: ['-n (den Kindern, den Freunden)', '-s', '-e', '-er'],
      ...
      },
      {
        ...
        options: ['dem / den', 'den / dem', 'dem / der', 'der / den'],
  ...
  // 11. Модальные глаголы (11 вопросов)
  {
    id: 'lesson-11',
    number: 11,
    ...
    totalLearners: 950,
    passThreshold: 70,
    tags: ['A1.1', 'Грамматика', 'Модальные глаголы', 'Modalverben'],
    isComingSoon: false,
    questions: [
      {
        id: 'l11-q1',
      ...
      },
      {
        ...
        options: ['Kannst', 'Könnst', 'Könnt', 'Kann'],
      ...
      },
      {
        ...
        options: ['muss', 'müsse', 'musst', 'müsst'],
        correctAnswer: 'muss',
      ...
      },
      {
        ...
        options: ['darf', 'dürft', 'darfst', 'dürfen'],
        correctAnswer: 'darf',
      ...
      },
      {
        ...
        options: ['wollen', 'wollt', 'will', 'wolle'],
      ...
      },
      {
        ...
        options: ['soll', 'solle', 'sollst', 'sollt'],
        correctAnswer: 'soll',
      ...
      },
      {
        ...
        options: ['möchten', 'möchtet', 'möchte', 'mag'],
      ...
      },
      {
        id: 'l11-q9',
        type: 'single-choice',
        promptDe: 'Welcher Satz drückt eine Fähigkeit (Умение/Навык) aus?',
      ...
      },
      {
        ...
        options: ['kann', 'könnt', 'kannst', 'könnte'],
        correctAnswer: 'kann',
  ...
  // 12. Комплексный экзамен A1.1 (Abschlussprüfung A1.1) (14 вопросов)
  {
    id: 'lesson-12',
    number: 12,
    ...
    totalLearners: 920,
    passThreshold: 75,
    tags: ['Экзамен', 'A1.1', 'Abschlussprüfung', 'Комплексный'],
    isComingSoon: false,
    questions: [
      {
        id: 'l12-q1',
        type: 'fill-gap',
        promptDe: '[Тема: Слабые глаголы] „Wir ______ seit zwei Jahren in Wien.“ (wohnen)',
      ...
      },
      {
        id: 'l12-q2',
        type: 'fill-gap',
        promptDe: '[Тема: Сильные глаголы] „______ du am Wochenende nach Berlin?“ (fahren)',
      ...
      },
      {
        id: 'l12-q3',
        type: 'fill-gap',
        promptDe: '[Тема: Сильные глаголы] „Er ______ sehr leise und undeutlich.“ (sprechen)',
        promptRu: 'Вставьте форму глагола sprechen (e → i) для «er»:',
        options: ['spricht', 'sprecht', 'sprichst', 'spreche'],
      ...
      },
      {
        id: 'l12-q4',
        type: 'fill-gap',
        promptDe: '[Тема: Артикли в Akkusativ] „Ich brauche ______ neuen Laptop.“ (der Laptop, maskulin)',
      ...
      },
      {
        id: 'l12-q5',
        type: 'single-choice',
        promptDe: '[Тема: Порядок слов] Welcher Satz ist grammatisch absolut korrekt?',
      ...
      },
      {
        id: 'l12-q6',
        type: 'fill-gap',
        promptDe: '[Тема: W-Fragen] „______ hast du gestern getroffen?“ — „Meinen Freund Alex.“',
      ...
      },
      {
        id: 'l12-q7',
        type: 'fill-gap',
        promptDe: '[Тема: Отрицание nicht / kein] „Wir haben leider ______ Milch mehr im Kühlschrank.“ (die Milch)',
      ...
      },
      {
        id: 'l12-q8',
        type: 'fill-gap',
        promptDe: '[Тема: Притяжательные местоимения] „Er besucht heute ______ Eltern.“ (Plural von er)',
        promptRu: 'Вставьте притяжательное местоимение от «er» во множественном числе (seine):',
        options: ['seine', 'sein', 'seinen', 'ihre'],
        correctAnswer: 'seine',
      ...
      },
      {
        id: 'l12-q9',
        type: 'single-choice',
        promptDe: '[Тема: Imperativ] Wie lautet die höfliche Bitte an Herrn Braun?',
      ...
      },
      {
        id: 'l12-q10',
        type: 'single-choice',
        promptDe: '[Тема: Числительные] Wie lautet die Zahl „68“ auf Deutsch?',
        promptRu: 'Как пишется число 68?',
        options: ['achtundsechzig', 'sechzigundacht', 'achtundsiebzig', 'sechsundachtzig'],
      ...
      },
      {
        id: 'l12-q11',
        type: 'fill-gap',
        promptDe: '[Тема: Dativ] „Ich helfe ______ alten Dame über die Straße.“ (die Dame, feminin)',
      ...
      },
      {
        id: 'l12-q12',
        type: 'fill-gap',
        promptDe: '[Тема: Dativ Plural] „Die Lehrerin erklärt ______ Schülern die Grammatik.“ (die Schüler, Plural)',
      ...
      },
      {
        id: 'l12-q13',
        type: 'fill-gap',
        promptDe: '[Тема: Модальные глаголы] „Sie (она) ______ fließend Spanisch und Deutsch sprechen.“ (können)',
      ...
      },
      {
        id: 'l12-q14',
        type: 'single-choice',
        promptDe: '[Тема: Модальные глаголы + Satzbau] Welcher Satz ist fehlerfrei gebaut?',
